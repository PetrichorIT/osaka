...
//! Osaka `mpsc` channel for both directions of communication. Instead of calling
...
//! to async_, you should use an unbounded Osaka `mpsc` channel.
//!
...
//! within a Osaka runtime, however it is still not tied to one specific Osaka
//! runtime, and the sender may be moved from one Osaka runtime to another.
//!
