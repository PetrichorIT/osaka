...
///
/// A `Notify` can be thought of as a [`Semaphore`](crate::sync::Semaphore) starting with 0 permits. The
...
/// [`Semaphore`](crate::sync::Semaphore): crate::sync::Semaphore
#[derive(Debug)]
pub struct Notify {
