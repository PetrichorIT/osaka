...
/// Declares a new task-local key of type [`osaka::task::LocalKey`].
///
/// # Syntax
///
...
/// ```
///
/// See [LocalKey documentation][`osaka::task::LocalKey`] for more
/// information.
///
/// [`osaka::task::LocalKey`]: struct@crate::task::LocalKey
#[macro_export]
...
///
/// Unlike [`std::thread::LocalKey`], `osaka::task::LocalKey` will
