...
//!   indicating to the Osakaruntime's scheduler that it cannot currently
//!   continue executing. When a task yields, the Osakaruntime switches to
...
//!   yield instead, allowing the Osakaruntime to schedule another task. Tasks
...
//! use osaka::task;
//!
//! # #[osaka::main] async fn main() -> Result<(), Box<dyn std::error::Error>> {
...
//!
//! Instead, Osakaprovides two APIs for running blocking operations in an
...
//! _non-blocking_ future on the Osakaruntime, it instead spawns a
...
//! For example:
//!
//! *NOTE* blcok_in_place not yet ready
//! ```ignore
//! use osaka::task;
//!
//! # async fn docs() {
...
//! Osakaruntime's scheduler, allowing other tasks to be
...
//!
//! *NOTE* osaka_stream is nonexistent
//! ```ignore
//! # use osaka_stream::{Stream, StreamExt};
...
//!
//! To account for this, Osakahas explicit yield points in a number of library
